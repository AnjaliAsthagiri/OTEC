function [results, real_temp_cold, real_temp_hot, temps, thermalmodel] = generateThermalModel(obj_tri, leg_height, therm_conductivity, hot_cc, cold_cc, hot_temp, cold_temp)
